...
public class Exercise4 {
    ...
    private List<String> getFrequentlyOccurringWords(String text, int numberWords) {
        ...
        return Arrays.stream(text.split("\\s"))
                     ...
                     .collect(Collectors.toMap(Function.identity(), i -> 1, (e1, e2) -> e1 + e2))
                     .entrySet()
                     .stream().sorted(Comparator.comparing((Function<Map.Entry<String, Integer>, Integer>) Map.Entry::getValue,
                                                            (v1, v2) -> Integer.compare(v2, v1))
    ...
    public void test2() {
        ...
        assertEquals(Arrays.asList("consectetur", "faucibus", "ipsum", "lorem", "adipiscing", "amet", "dolor", "eget", "elit", "mi"),
                result);
    }
}
